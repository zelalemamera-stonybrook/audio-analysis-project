# the following praat script uses the third tier of each textgrid to break down the audio into syllables. This is only for syllable length 4
...
for i from 1 to n
	...
	Extract intervals where: 3,"yes", "is equal to", "4"
	Save as WAV file: target$ + wav$ + "_syll4.wav"
	Remove
