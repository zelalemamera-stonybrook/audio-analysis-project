'''
This code tests the baseline model. We test each batch separately. The model is trained on all batches.
'''
import json
...
def test_baseline(model, network: BaselineModel, input: list, gold: list):
	'''
...
def evaluate(model, network: BaselineModel, input: str, syll: int, gold: list):
	'''
