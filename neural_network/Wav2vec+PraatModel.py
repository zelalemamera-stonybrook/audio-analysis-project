...
class Network(nn.Module):
	...
	def __init__(self):
		...
		self.left_rnn_in = nn.parameter.Parameter(torch.rand((500,756)) - 0.5)
		...
		self.right_rnn_in = nn.parameter.Parameter(torch.rand((500,756))-0.5)
