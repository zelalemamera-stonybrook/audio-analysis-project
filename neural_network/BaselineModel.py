'''
This program implements the baseline model. The baseline takes in raw audio as its imput and returns a transformation that does not use any additional features.
'''
...
class Network(nn.Module):
	...
	def forward(self, input: list[Tensor], feature=None):
		'''
